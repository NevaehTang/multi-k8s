...
kubectl set iamge deployments/client-deployment client=nevaehtang/multi-client:$SHA
kubectl set iamge deployments/worker-deployment worker=nevaehtang/multi-worker:$SHA
